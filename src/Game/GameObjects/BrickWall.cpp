...
{
	//из static_cast<size_t>(EBrickState::SOMETHING) получается индекс элемента перечисления
	...
	case EBrickWallType::Top:
		m_eCurrentBrickState[static_cast<size_t>(EBrickLocation::TopLeft)] = EBrickState::All; //ALL это полность кирпичный квадрат 8x8
		m_eCurrentBrickState[static_cast<size_t>(EBrickLocation::TopRight)] = EBrickState::All;
		break;
	case EBrickWallType::Bottom:
		m_eCurrentBrickState[static_cast<size_t>(EBrickLocation::BottomLeft)] = EBrickState::All; //ALL это полность кирпичный квадрат 8x8
	...
	case EBrickWallType::Right:
		m_eCurrentBrickState[static_cast<size_t>(EBrickLocation::TopRight)] = EBrickState::All; //ALL это полность кирпичный квадрат 8x8
		m_eCurrentBrickState[static_cast<size_t>(EBrickLocation::BottomRight)] = EBrickState::All;
		break;
